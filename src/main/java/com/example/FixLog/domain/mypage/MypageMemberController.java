...
import com.example.FixLog.domain.mypage.dto.PresignResponseDto;
import com.example.FixLog.common.exception.Response;
import com.example.FixLog.domain.member.dto.edit.EditNicknameRequestDto;
import com.example.FixLog.domain.member.dto.edit.EditPasswordRequestDto;
import com.example.FixLog.domain.member.dto.edit.EditBioRequestDto;
...
import com.example.FixLog.infra.s3.PresignedUploadResponseDto;
...
public class MypageMemberController {
    ...
    public ResponseEntity<Response<PresignResponseDto>> presignProfileImage(
        ...
        if (member == null) throw new CustomException(ErrorStatus.UNAUTHORIZED);
