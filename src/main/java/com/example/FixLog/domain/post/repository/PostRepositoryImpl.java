...
import static com.example.FixLog.domain.post.domain.QPost.post;
import static com.example.FixLog.domain.post.domain.QPostTag.postTag;
import static com.example.FixLog.domain.tag.domain.QTag.tag;
